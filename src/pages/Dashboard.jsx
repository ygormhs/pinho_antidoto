    ...
    return (
        <div className="space-y-8 lg:space-y-12 pt-8 pb-32 lg:pb-0">
            ...
            <motion.div
                ...
                className="hidden lg:block bg-white p-10 rounded-[2.5rem] shadow-3d mb-12 relative overflow-hidden group border border-gray-50"
            >
                <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity">
                    <span className="text-9xl font-serif text-brand-text">"</span>
                </div>
                <div className="relative z-10">
                    <p className="text-3xl font-bold text-gray-800 leading-tight tracking-tight mb-6">
                        {quote.text}
                    </p>
